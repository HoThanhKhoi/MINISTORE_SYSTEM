            ...
            <div class="row">
                ...
                <c:if test="${requestScope.product != null}">
                    <div class="col-6">
                        ...
                        <div class="d-flex group-price mt-5">
                        ...
                        <div class="col">
                            ...
                            <div class="item mb-4 text-center">
                                <div class="card border-0 shadow align-items-center">
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title fw-bold mb-2">${proCate.productName}</h5>
                                        <span class="bricked-price mx-2">${proCate.price}</span>
                                        <span class="price fw-bold mx-2">${Math.round(proCate.price) -0.45}</span></br>
                                        <input type="hidden" name="pid" value="${product.productID}"/>
                                        <input type="hidden" name="cid" value="${requestScope.cateID}"/>
                                        <a href="MainController?action=addToCart&quantity=1&pid=${proCate.productID}&cid=${proCate.cateID}" class="btn btn-primary px-3 py-2 fw-bold" name="action" value="addToCart">Add To Cart</a>
                                    </div>
                                </div>
                            </div>
                            <!-- end item -->
