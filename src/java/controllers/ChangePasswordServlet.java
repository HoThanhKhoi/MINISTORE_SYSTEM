<<<<<<<< HEAD:src/java/controllers/ChangePasswordServlet.java
/*
 ...
 * @author Admin
 */
public class ShowPaginateServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ArrayList<Product> list = ProductDAO.getPaginatedProduct(pageNumber, productPerPage);
            if (list != null) {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ShowPaginateServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
>>>>>>>> origin/Bao:src/java/controllers/ShowPaginateServlet.java
